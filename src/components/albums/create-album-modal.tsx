...
export function CreateAlbumModal({ open, onOpenChange, onCreated }: CreateAlbumModalProps) {
    ...
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="sm:max-w-md">
        <DialogHeader>
          ...
          <DialogDescription>Create a new album to organize your family photos</DialogDescription>
        </DialogHeader>
